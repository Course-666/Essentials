...
//Name: MyBook.ma
//Last modified: Thu, Apr 16, 2026 10:48:19 AM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "AC3FE684-46C3-B9FE-82E0-A4B0B429824C";
...
createNode transform -s -n "persp";
	rename -uid "ECE6718F-4855-ED11-A62B-83933E4E7EDF";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.3458985585911645 5.1881358203279575 -0.81415698331591457 ;
	setAttr ".r" -type "double3" -17.738352729681903 339.40000000001191 -8.4945309567098612e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "024C4EE4-4E5E-D25A-617B-D48634E3184D";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 9.2381970069484147;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 4.5089948122104921 1.7263206288310644 -7.130126952591934 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "3F6A24EE-4136-CEB6-7E52-799FE172A0ED";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "C828A7DA-4019-B90F-73A0-9F98A1F1C0C1";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "AA81B159-4B67-FD80-72ED-0B9E006382B7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "5898876C-418D-FF21-BED7-7CAEE5FBC9DC";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "E145D548-4D5C-D0AC-B12E-6784850B1CCA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "8420D06F-46FD-EC3A-5F1F-909307E710DC";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1EF5B15E-4AC7-6405-EDCB-A5BB5B655BF9";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CBD49A3D-46CC-501D-C61B-BFAA4DEE5815";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4B719FB0-447C-1300-0485-D6A8C5409DC2";
createNode displayLayerManager -n "layerManager";
	rename -uid "063A7B7B-4EEC-0307-D58F-3290EEC93E82";
createNode displayLayer -n "defaultLayer";
	rename -uid "FB387252-4FE8-143E-1FD0-56BF636C5766";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "06128CBF-434C-4EC2-F01C-00834545B5D3";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "1C311AAD-4F76-53C4-8907-0C89BD8C8212";
	setAttr ".g" yes;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "9949468E-4709-4EB6-9A35-59A41C97006F";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "866B51C2-41DA-E0E5-738E-0ABA59DB0172";
