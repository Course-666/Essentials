...
//Last modified: Wed, Apr 15, 2026 02:41:08 PM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "4F93CDEC-449E-5EFE-CC7A-56AC66294AAE";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -46.780283427681773 8.8322778213779412 0.64103105038939034 ;
	setAttr ".r" -type "double3" -11.738352729859407 -73.800000000093647 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "6FFAA1E1-4B21-5FFC-FE56-329E24008D87";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 45.293537850961997;
...
createNode displayLayerManager -n "layerManager";
	rename -uid "BABDA7FE-4716-22F3-F0A5-929827F078ED";
	setAttr ".cdl" 3;
	setAttr -s 4 ".dli[1:3]"  1 4 3;
	setAttr -s 2 ".dli";
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1DDF8408-4F64-C8AE-1341-4CAD6BBBFAA3";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "FF265B1D-4AAE-D190-2ADF-3D99FE23C327";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "48622B00-4892-79A9-5816-F88FAA156136";
createNode displayLayer -n "defaultLayer";
	rename -uid "F46CF401-42D5-3EB8-4B7C-20B29F3AA37E";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D65F6FDD-4437-844B-93B5-10BD114A5EFB";
...
createNode polyTweakUV -n "polyTweakUV1";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".uvtk";
	setAttr ".uvtk[18]" -type "float2" 1.1995054 0 ;
	setAttr ".uvtk[19]" -type "float2" 1.1995053 0 ;
	setAttr ".uvtk[20]" -type "float2" 1.1995056 0 ;
	setAttr ".uvtk[21]" -type "float2" 1.1995054 0 ;
	setAttr ".uvtk[22]" -type "float2" 1.1995056 0 ;
	setAttr ".uvtk[23]" -type "float2" 1.1995053 0 ;
	setAttr ".uvtk[24]" -type "float2" 1.1995053 0 ;
	setAttr ".uvtk[25]" -type "float2" 1.1995056 0 ;
...
createNode polyTweak -n "polyTweak2";
	...
	setAttr ".tk[3]" -type "float3" 0 0.0018982892 0 ;
	setAttr ".tk[4]" -type "float3" 0 -0.021784186 0 ;
	setAttr ".tk[5]" -type "float3" 0 -0.021784186 0 ;
...
createNode polyTweak -n "polyTweak4";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[2]" -type "float3" 0 -0.012020584 0 ;
	setAttr ".tk[3]" -type "float3" 0 -1.8626451e-09 0 ;
	setAttr ".tk[4]" -type "float3" 0 -0.03018726 0 ;
	setAttr ".tk[5]" -type "float3" 0 -0.018166672 0 ;
createNode polyTweakUV -n "polyTweakUV10";
	rename -uid "7B9AF356-4B52-A4B0-B778-A89EE97B46EC";
	setAttr ".uopa" yes;
	setAttr -s 5 ".uvtk";
	setAttr ".uvtk[24]" -type "float2" -0.014758561 5.9371814e-08 ;
	setAttr ".uvtk[25]" -type "float2" -0.014758561 5.9371814e-08 ;
	setAttr ".uvtk[26]" -type "float2" -0.014758561 5.9371814e-08 ;
	setAttr ".uvtk[27]" -type "float2" -0.014758561 5.9371814e-08 ;
...
createNode polyTweakUV -n "polyTweakUV11";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".uvtk";
	setAttr ".uvtk[28]" -type "float2" -0.027436541 0.97526574 ;
	setAttr ".uvtk[29]" -type "float2" -0.027436536 0.97526556 ;
	setAttr ".uvtk[30]" -type "float2" -0.027436482 0.97526562 ;
	setAttr ".uvtk[31]" -type "float2" -0.027436482 0.97526574 ;
...
createNode polyTweakUV -n "polyTweakUV12";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".uvtk";
	setAttr ".uvtk[32]" -type "float2" -0.26932722 -2.0129428 ;
	setAttr ".uvtk[33]" -type "float2" 0.021094136 -0.020750221 ;
	setAttr ".uvtk[34]" -type "float2" 0.0073819188 -0.018743133 ;
	setAttr ".uvtk[35]" -type "float2" -0.28419474 -2.0107665 ;
...
connectAttr "polyTweakUV13.out" "|Wall_1|Wall_1.i";
